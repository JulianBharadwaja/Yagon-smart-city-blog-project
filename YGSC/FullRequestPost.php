...
if (isset($_POST["Submit"])) {
  ...
  if (empty($Name) || empty($Email) || empty($Comment)) {
    ...
    Redirect_to("FullRequestPost.php?id=$PostIdFromURL");
    ...
    $sql = "INSERT INTO comments_requests(datetime,name,email,comment,approvedby,status,request_id)";
    ...
    <section class="container">
      <div class="site-content">
        <div class="posts">
          ...
          echo ErrorMessage();
          echo SuccessMessage();
          $sql = "SELECT * FROM requests WHERE id='$PostIdFromURL'";
          $stmt = $con->query($sql);
          ...
          ?>
            ...
            <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="post-image">
                <div>
                  <img src="Uploads/<?php echo htmlentities($Image); ?>" class="img" alt="blog1" style="max-width: 30% !important;">
                </div>
              ...
              <div class="post-title">
                <p>Request Host's Name :<?php echo htmlentities($User); ?></p>
                <p>Host's Job :<?php echo htmlentities($Job); ?></p>
                <p>Host's Type :<?php echo htmlentities($Type); ?></p>
                <p>Location : <?php echo htmlentities($Location); ?></p>
                <p>Time : <?php echo htmlentities($DateTime); ?></p>
                <p style="background-color: orange; color:white !important; padding: 5px; border-radius: 2px;"><?php echo htmlentities($PostDescription); ?></p>
              </div>
            </div>
            <!-- CLOSING WHILE LOPP -->
          <?php } ?>
          ...
          <?php
          global $con;
          $sql = "SELECT * FROM comments_requests WHERE request_id='$PostIdFromURL' AND status='ON'";
          $stmt = $con->query($sql);
          while ($DataRows = $stmt->fetch()) {
          ...
          <form action="FullRequestPost.php?id=<?php echo $PostIdFromURL; ?>" method="post">
