...
if (isset($_POST["Submit"])) {
  ...
  if (empty($Name) || empty($Email) || empty($Comment)) {
    ...
    Redirect_to("FullProjectPost.php?id=$PostIdFromURL");
    ...
    $sql = "INSERT INTO comments_projects(datetime,name,email,comment,approvedby,status,project_id)";
    ...
    <section class="container">
      <div class="site-content">
        <div class="posts">
          ...
          echo ErrorMessage();
          echo SuccessMessage();
          $sql = "SELECT * FROM projects WHERE id='$PostIdFromURL'";
          $stmt = $con->query($sql);
          ...
          <?php
          global $con;
          $sql = "SELECT * FROM comments_projects WHERE project_id='$PostIdFromURL' AND status='ON'";
          $stmt = $con->query($sql);
          while ($DataRows = $stmt->fetch()) {
          ...
          <form action="FullProjectPost.php?id=<?php echo $PostIdFromURL; ?>" method="post">
