...
<head>
  ...
  <title>Update - Yangon Smart City</title>
      ...
      <div class="site-content">
        <div class="posts">
          ...
          ?>
            ...
            <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="post-title">
                ...
                <a class="btn post-btn" href="FullUpdatePost.php?id=<?php echo $PostId; ?>">Read More &nbsp; <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
            <hr>
            <!-- CLOSING WHILE LOPP -->
          ...
          <div class="pagination flex-row">
            ...
            // echo $PostPagination;
            ?>
            <a href="index.php?page=" class="pages">0</a>
            <?php
            for ($i = 1; $i <= $PostPagination; $i++) {
              if (isset($Page)) {
                if ($i == $Page) {
            ?>
                  <a href="index.php?page=<?php echo $i; ?>" class="pages"><?php echo $i; ?></a>
                <?php } else { ?>
                  <a href="index.php?page=<?php echo $i; ?>" class="pages"><?php echo $i; ?></a>
                <?php
                } ?>
            ...
            ?>
              ...
              <a href="index.php?page=2"><i class="fas fa-chevron-right"></i></a>
            <?php } ?>
          </div>
        </div>
