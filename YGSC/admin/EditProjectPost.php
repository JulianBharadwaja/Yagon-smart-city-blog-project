...
<head>
  ...
  <title>Edit Project Posts - Yangon Smart City</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4 text-danger"><i class="fas fa-puzzle-piece"></i>&nbsp;Edit Project Post</h1>
        ...
        <div class="row">
          <div class="offset-lg-1 col-lg-10" style="min-height: 400px">
            ...
            while ($DataRows = $stmtPost->fetch()) {
              ...
              $CategoryToBeUpdated = $DataRows['project_category'];
              $TypeToBeUpdated = $DataRows['project_type'];
              $LocationToBeUpdated = $DataRows['location'];
              $ImageToBeUpdated = $DataRows['image'];
              $PostToBeUpdated = $DataRows['ppost'];
            }
            ?>
              ...
              <div class="card bg-secondary text-light">
                <div class="card-body bg-dark">
                  ...
                  <div class="form-group">
                    <label for="title"> <span class="FieldInfo">Project Category Title:</span> </label>
