...
while ($DataRows = $stmtPost->fetch()) {
  ...
  $CategoryToBeDelete = $DataRows['category'];
  $ImageToBeDelete = $DataRows['image'];
  $PostToBeDelete = $DataRows['post'];
}
...
<head>
  ...
  <title>Delete Posts - Yangon Smart City</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4 text-danger"><i class="fas fa-newspaper"></i>&nbsp;Delete Post</h1>
