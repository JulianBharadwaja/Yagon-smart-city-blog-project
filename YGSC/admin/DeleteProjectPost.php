...
while ($DataRows = $stmtPost->fetch()) {
  ...
  $CategoryToBeDelete = $DataRows['project_category'];
  $TypeToBeDelete = $DataRows['project_type'];
  $LocationToBeDelete = $DataRows['location'];
  $ImageToBeDelete = $DataRows['image'];
  $PostToBeDelete = $DataRows['ppost'];
}
...
<head>
  ...
  <title>Delete Project - Yangon Smart City</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4 text-danger"><i class="fas fa-newspaper"></i>&nbsp;Delete Project Post</h1>
        <ol class="breadcrumb mb-4">
          <li class="breadcrumb-item active">Delete Project Post</li>
        </ol>
      </div>
      <!-- MAIN AREA -->
