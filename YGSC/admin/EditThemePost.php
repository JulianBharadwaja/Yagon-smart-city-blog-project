...
if (isset($_POST['Submit'])) {
  ...
  if (empty($PostTitle)) {
    ...
    if (!empty($Image)) {
      $sql = "UPDATE themes 
            SET title='$PostTitle', theme_category ='$Category',  image ='$Image', tpost ='$PostText' 
            WHERE id='$SearchQueryParameter'";
    } else {
      $sql = "UPDATE themes 
            SET title='$PostTitle', theme_category ='$Category', tpost ='$PostText' 
            WHERE id='$SearchQueryParameter'";
    }
...
<head>
  ...
  <title>Edit Theme - Yangon Smart City</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4 text-danger"><i class="fas fa-newspaper"></i>&nbsp;Edit Theme</h1>
      ...
      <section class="container py-2 mb-4">
        <div class="row">
          <div class="offset-lg-1 col-lg-10" style="min-height: 400px">
            ...
            echo SuccessMessage();
            global $con;
            $sql = "SELECT * FROM themes WHERE id = '$SearchQueryParameter'";
            $stmtPost = $con->query($sql);
            while ($DataRows = $stmtPost->fetch()) {
              $TitleToBeUpdated = $DataRows['title'];
              $CategoryToBeUpdated = $DataRows['theme_category'];
              $ImageToBeUpdated = $DataRows['image'];
              $PostToBeUpdated = $DataRows['tpost'];
            }
            ?>
