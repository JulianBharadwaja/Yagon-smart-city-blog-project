...
<head>
  ...
  <title>Projects - Yangon Smart City</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4">Project Data Tables</h1>
        <!-- BREADCRUMB FOR THE TABLE TO DASHBOARD -->
        <ol class="breadcrumb mb-4">
          <li class="breadcrumb-item"><a href="Dashboard.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Project Data Tables</li>
        </ol>
        <div class="row">
          <div class="col-xl-6 col-md-6">
            <div class="card bg-primary text-white mb-4">
              <div class="card-body"><i class="fas fa-edit"></i>&nbsp;Add New Project</div>
          ...
          <div class="col-xl-6 col-md-6">
            <div class="card bg-warning text-white mb-4">
              <div class="card-body"><i class="fas fa-folder-plus">&nbsp;</i>Add New Project Category</div>
              <div class="card-footer d-flex align-items-center justify-content-between">
                <a class="small text-white stretched-link" href="ProjectCategories.php">Click Here!</a>
                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
              </div>
            </div>
          </div>
                ...
                ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="EditProjectPost.php?id=<?php echo $Id; ?>">
                          <span class="btn btn-warning"><i class="fas fa-edit"></i></span>
                        </a>
                        <a href="DeleteProjectPost.php?id=<?php echo $Id; ?>">
                          <span class="btn btn-danger"><i class="fas fa-trash-alt"></i></span>
                        </a>
                      </td>
                      <td>
                        <a href="../FullProjectPost.php?id=<?php echo $Id; ?>">
