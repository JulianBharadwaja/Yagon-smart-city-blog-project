...
while ($DataRows = $stmtPost->fetch()) {
  ...
  $CategoryToBeDelete = $DataRows['theme_category'];
  $ImageToBeDelete = $DataRows['image'];
  $PostToBeDelete = $DataRows['tpost'];
}
...
<head>
  ...
  <title>Delete Themes - Yangon Smart City</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4 text-danger"><i class="fas fa-newspaper"></i>&nbsp;Delete Theme Post</h1>
        <ol class="breadcrumb mb-4">
          <li class="breadcrumb-item active">Delete Theme Post</li>
        </ol>
      </div>
      <!-- MAIN AREA -->
